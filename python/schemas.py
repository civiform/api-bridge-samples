...
``discovery_document`` builder that advertises them to clients.
"""

COMPATIBILITY_LEVEL = "v1"
BRIDGE_SLUG = "check-utility-customer"
LOOKUP_BRIDGE_SLUG = "lookup-utility-customer"

JSON_SCHEMA_DRAFT = "https://json-schema.org/draft/2020-12/schema"
SCHEMA_ID_BASE = "https://civiform.us/schemas"

REQUEST_SCHEMA = {
    "$schema": JSON_SCHEMA_DRAFT,
    "$id": f"{SCHEMA_ID_BASE}/check-utility-customer-request.json",
...
RESPONSE_SCHEMA = {
    "$schema": JSON_SCHEMA_DRAFT,
    "$id": f"{SCHEMA_ID_BASE}/check-utility-customer-response.json",
...
LOOKUP_REQUEST_SCHEMA = {
    "$schema": JSON_SCHEMA_DRAFT,
    "$id": f"{SCHEMA_ID_BASE}/lookup-utility-customer-request.json",
...
LOOKUP_RESPONSE_SCHEMA = {
    "$schema": JSON_SCHEMA_DRAFT,
    "$id": f"{SCHEMA_ID_BASE}/lookup-utility-customer-response.json",
